...
const FooterButtons = (props) => {
    ...
    return (
        <div className="form-actions" style={{"marginTop":"0", "padding":"0.75em"}}>    
                ...
                <button title="Alle Änderungen werden gespeichert" className="button button--positive button-save" type="save" value="publish" onClick={onPublish} disabled={(! stateChanged || hasConflicts || (data && ! data.__modified))}>Alle Änderungen aktivieren
                </button>
