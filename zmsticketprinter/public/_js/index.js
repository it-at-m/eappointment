...
var _newhashDefault = parcelHelpers.interopDefault(_newhash);
...
var _digitalClockDefault = parcelHelpers.interopDefault(_digitalClock);
var _notificationKeyboardHandheld = require("./block/notification-keyboard-handheld");
var _notificationKeyboardHandheldDefault = parcelHelpers.interopDefault(_notificationKeyboardHandheld);
...
window.bo = {
    "zmsticketprinter": (0, _settingsDefault.default)
};
(0, _jqueryDefault.default)("#newhash").each(function() {
    new (0, _newhashDefault.default)(this);
});
(0, _jqueryDefault.default)("#index, #message, #exception").each(function() {
    new (0, _mainDefault.default)(this);
});
(0, _jqueryDefault.default)("#process").each(function() {
    new (0, _processDefault.default)(this);
});
if ((0, _jqueryDefault.default)(".digitaluhr").length > 0) {
    console.log("Found digitaluhr elements, initializing DigitalTime...");
    (0, _jqueryDefault.default)(".digitaluhr").each(function() {
        new (0, _digitalClockDefault.default)(this);
    });
} else console.log("No digitaluhr elements found.");
(0, _jqueryDefault.default)(".smsbox").each(function() {
    new (0, _notificationKeyboardHandheldDefault.default)(this);
});
...
},{"jquery":"hgMhh","./settings":"gazc6","./page/main":"MFFjK","./page/newhash":"2CNyj","./page/process":"bo5qa","./block/digital-clock":"1WBzi","./block/notification-keyboard-handheld":"4tHhT","./element/form/preventFormResubmit":"4Yr4n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}],"gazc6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"MFFjK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class View extends (0, _baseviewDefault.default) {
    ...
    reloadPage() {
        console.log("reload...");
        (0, _jqueryDefault.default).get(this.getUrl("/home/"), function(response) {
            (0, _jqueryDefault.default)("body").html((0, _jqueryDefault.default)((0, _jqueryDefault.default).parseHTML(response)));
        });
    }
    setReloadInterval() {
...
class BaseView extends (0, _errorHandlerDefault.default) {
    ...
    static loadDialogStatic(response, callback) {
        const { lightboxContentElement, destroyLightbox } = (0, _utils.lightbox)(this.$main, ()=>{
...
},{"jquery":"hgMhh","./errorHandler":"aefDX","./dialogHandler":"j0eMK","./utils":"hrKrV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aefDX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"j0eMK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
class DialogHandler {
    ...
    render() {
        var content = (0, _jqueryDefault.default)(this.response).filter("div.dialog");
        if (content.length == 0) {
            var message = (0, _jqueryDefault.default)(this.response).find("div.dialog");
...
},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hrKrV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const forceHttps = ()=>{
    if (document.location.protocol !== "https:") (0, _baseviewDefault.default).loadCallStatic(`${(0, _settingsDefault.default).includeUrl}/dialog/?template=force_https`).then((response)=>{
        (0, _baseviewDefault.default).loadDialogStatic(response, ()=>{
...
},{"jquery":"hgMhh","./baseview":"k1LZ3","../settings":"gazc6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2CNyj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _baseview = require("../lib/baseview");
var _baseviewDefault = parcelHelpers.interopDefault(_baseview);
...
class View extends (0, _baseviewDefault.default) {
    constructor(element){
        ...
        (0, _jqueryDefault.default)(window).on("load", this.load);
    }
    load() {
        (0, _jsCookieDefault.default).remove("Ticketprinter");
        this.setTimeout();
    }
    reloadPage() {
...
},{"../lib/baseview":"k1LZ3","js-cookie":"491w8","jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"491w8":[function(require,module,exports) {
(function(factory) {
...
},{}],"bo5qa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _baseview = require("../lib/baseview");
var _baseviewDefault = parcelHelpers.interopDefault(_baseview);
...
},{"../lib/baseview":"k1LZ3","jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1WBzi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _baseview = require("../lib/baseview");
var _baseviewDefault = parcelHelpers.interopDefault(_baseview);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
class DigitalTime extends (0, _baseviewDefault.default) {
    constructor(element){
        super(element);
    ...
    initClock() {
        ...
        (0, _jqueryDefault.default)(this.element).text(temp);
    }
    startClock() {
        this.initClock();
...
exports.default = DigitalTime;

},{"../lib/baseview":"k1LZ3","jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4tHhT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _baseview = require("../lib/baseview");
var _baseviewDefault = parcelHelpers.interopDefault(_baseview);
...
class View extends (0, _baseviewDefault.default) {
    constructor(element){
        ...
        if (this.source == "waitingNumberPad") this.minNumberLength = 1;
        else this.minNumberLength = 10;
    ...
    appendNumber(event) {
        let $content = (0, _jqueryDefault.default)(event.target).closest("button");
    ...
    checkNumber() {
        ...
        if (this.source == "waitingNumberPad") number = number.replace(/^0+/, "");
        number = number.replace(/[^\d]/g, "");
        var $button = this.$.find(".nachtrag");
        if (number.length >= this.minNumberLength) $button.removeClass("disabled").attr("disabled", false);
        else if (!$button.hasClass("disabled")) $button.addClass("disabled").attr("disabled", true);
        this.$numberInput.val(number);
    }
}
exports.default = View;

},{"../lib/baseview":"k1LZ3","jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4Yr4n":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
...
},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1Z4Rq"], "1Z4Rq", "parcelRequireafe7")
