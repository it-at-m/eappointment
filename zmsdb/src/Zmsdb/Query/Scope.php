...
class Scope extends Base implements MappingInterface
{
    ...
    public function getEntityMapping()
    {
        return [
            ...
            'preferences__appointment__infoForNoAppointments' => 'scope.info_for_no_appointments',
    ...
    public function reverseEntityMapping(\BO\Zmsentities\Scope $entity, $parentId = null)
    {
        ...
        $data['info_for_no_appointments'] = $entity->getPreference('appointment', 'infoForNoAppointments');
