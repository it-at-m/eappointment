...
class Mail extends Base
{
    ...
    public function readEntities(array $itemIds, $resolveReferences = 1, $limit = 600, $order = 'ASC', $onlyIds = false)
    {
    ...
    public function readList($resolveReferences = 1, $limit = 600, $order = 'ASC', $onlyIds = false)
    {
        $mailList = new Collection();
        $query = new Query\MailQueue(Query\Base::SELECT);
        $query
