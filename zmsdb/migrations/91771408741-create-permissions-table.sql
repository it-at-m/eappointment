...
VALUES ('appointment',
       ...
       ('cluster', 'Cluster erstellen/aktualisieren/löschen'),
       ...
       ('department', 'Behörde erstellen/aktualisieren/löschen'),
       ...
       ('organisation', 'Referat erstellen/aktualisieren/löschen'),
       ...
       ('scope', 'Standort erstellen/aktualisieren/löschen'),
