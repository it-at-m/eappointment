...
define('ZMS_AUTHORIZATION_CONNECT_TIMEOUT', getenv('ZMS_AUTHORIZATION_CONNECT_TIMEOUT') ? getenv('ZMS_AUTHORIZATION_CONNECT_TIMEOUT') : 5);
define('ZMS_AUTHORIZATION_SSL_VERIFY', getenv('ZMS_AUTHORIZATION_SSL_VERIFY') ? getenv('ZMS_AUTHORIZATION_SSL_VERIFY') : false);
...
class App extends \BO\Zmsadmin\Application
{
    ...
    const ZMS_AUTHORIZATION_CONNECT_TIMEOUT = ZMS_AUTHORIZATION_CONNECT_TIMEOUT;
    const ZMS_AUTHORIZATION_SSL_VERIFY = ZMS_AUTHORIZATION_SSL_VERIFY;
