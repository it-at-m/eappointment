...
{
    /**
     * Shared free-process query used by zmsadmin / classic free-slot APIs (same semantics as next).
     *
     ...
     *
     * Occupancy is pre-aggregated from slot_process (same approach as Day::QUERY_DAYLIST_JOIN_AVAILABILITY).
     *
