...
class Useraccount extends \BO\Zmsbackend\Base
{
    ...
    protected function readDepartmentIdsForLoginName($loginName): array
    {
        ...
        $query = \BO\Zmsbackend\Useraccount\Repository\Useraccount::QUERY_READ_ASSIGNED_DEPARTMENTS;
    ...
    protected function applyWorkstationAccessFilter(\BO\Zmsbackend\Useraccount\Repository\Useraccount $query, $workstation): bool
    {
    ...
    protected function buildDepartmentListsForUsers(array $useraccountNames, array $assignmentsByUser, $resolveReferences = 0)
    {
        ...
        if (!empty($allDepartmentIds)) {
            ...
            $allDepartments = (new \BO\Zmsbackend\Department\Service\Department())->readEntitiesByIds($uniqueDepartmentIds, $resolveReferences);
        }
    ...
    protected function buildDepartmentList(array $items, $resolveReferences = 0)
    {
        ...
        $departments = (new \BO\Zmsbackend\Department\Service\Department())->readEntitiesByIds($departmentIds, $resolveReferences);
    ...
    public function writeUpdatedEntity($loginName, Entity $entity, $resolveReferences = 0)
    {
        ...
        $query = new \BO\Zmsbackend\Useraccount\Repository\Useraccount(\BO\Zmsbackend\Query\Base::UPDATE);
    ...
    public function deleteEntity($loginName)
    {
        ...
        $query = new \BO\Zmsbackend\Useraccount\Repository\Useraccount(\BO\Zmsbackend\Query\Base::DELETE);
        $query->addConditionLoginName($loginName);
    ...
    {
        $query = \BO\Zmsbackend\Useraccount\Repository\Useraccount::QUERY_READ_ID_BY_USERNAME;
    ...
    {
        $query = \BO\Zmsbackend\Useraccount\Repository\Useraccount::QUERY_DELETE_ASSIGNED_DEPARTMENTS;
        $userId = $this->readEntityIdByLoginName($loginName);
