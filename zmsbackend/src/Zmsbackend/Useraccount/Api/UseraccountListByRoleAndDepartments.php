...
class UseraccountListByRoleAndDepartments extends \BO\Zmsbackend\Api\BaseController
{
    /**
    ...
    public function readResponse(
        ...
        $workstation = (new \BO\Zmsbackend\Helper\User($request, 2))->checkPermissions('useraccount');
        ...
        $useraccountList = (new \BO\Zmsbackend\Useraccount\Service\Useraccount())->readListByRoleAndDepartmentIds(
            $roleName,
            $departmentIds,
            0,
            false,
