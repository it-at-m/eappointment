...
namespace BO\Zmsbackend\Link\Service;
...
class Link extends \BO\Zmsbackend\Base
{
    /**
    ...
    public function readByDepartmentId($departmentId, $disableCache = false)
    {
        ...
        $query = new \BO\Zmsbackend\Link\Repository\Link(\BO\Zmsbackend\Query\Base::SELECT);
        $query
            ->addEntityMapping()
    ...
    {
        $query = new \BO\Zmsbackend\Link\Repository\Link(\BO\Zmsbackend\Query\Base::INSERT);
