...
use BO\Zmsbackend\Availability\Exception\AvailabilityListUpdateFailed;
...
use BO\Zmsbackend\Availability\Api\AvailabilitySlotsUpdate;
 ...
 */
class AvailabilityListUpdate extends \BO\Zmsbackend\Api\BaseController
{
    /**
    ...
    public function readResponse(
        ...
        if (count($validationErrors) > 0) {
            ...
            $message->meta->exception = 'BO\\Zmsbackend\\Availability\\Exception\\AvailabilityListUpdateFailed';
