...
namespace BO\Zmsbackend\Workstation\Repository;

/**
 * @SuppressWarnings(Public)
 *
 */
class Workstation extends \BO\Zmsbackend\Query\Base implements \BO\Zmsbackend\Query\MappingInterface
{
    /**
    ...
    const QUERY_PROCESS_RESET = '
        UPDATE
            ' . \BO\Zmsbackend\Process\Repository\Process::TABLE . '
        SET
            `NutzerID` = 0,
            `aufrufzeit` = "00:00:00"
        WHERE
    ...
    public function addJoinUseraccount()
    {
        ...
        $joinQuery = new \BO\Zmsbackend\Useraccount\Repository\Useraccount($this, $this->getPrefixed('useraccount__'));
        return $joinQuery;
    }
