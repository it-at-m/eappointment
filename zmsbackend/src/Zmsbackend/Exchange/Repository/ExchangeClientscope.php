...
class ExchangeClientscope extends \BO\Zmsbackend\Query\Base
{
    /**
    ...
    FROM (
          SELECT
            ...
            FROM ' . \BO\Zmsbackend\Process\Repository\ProcessStatusArchived::TABLE . '
      ...
      UNION ALL
          SELECT
            ...
            FROM ' . \BO\Zmsbackend\Process\Repository\ProcessStatusArchived::TABLE . ' a
