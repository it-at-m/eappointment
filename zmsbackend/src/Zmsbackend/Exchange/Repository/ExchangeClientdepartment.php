...
class ExchangeClientdepartment extends \BO\Zmsbackend\Query\Base
{
    /**
    ...
    UNION ALL  
          ...
          FROM ' . \BO\Zmsbackend\Department\Repository\Department::TABLE . ' as d
    ...
    const QUERY_SUBJECTS = '
      ...
      FROM ' . \BO\Zmsbackend\Department\Repository\Department::TABLE . ' AS d
          ...
          LEFT JOIN ' . \BO\Zmsbackend\Organisation\Repository\Organisation::TABLE . ' AS o ON d.`OrganisationsID` = o.`OrganisationsID`
