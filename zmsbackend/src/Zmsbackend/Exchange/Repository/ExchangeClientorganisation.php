...
class ExchangeClientorganisation extends \BO\Zmsbackend\Query\Base
{
    /**
    ...
    FROM (
          SELECT
            ...
            FROM ' . \BO\Zmsbackend\Organisation\Repository\Organisation::TABLE . ' o
                LEFT JOIN ' . \BO\Zmsbackend\Department\Repository\Department::TABLE . ' d ON d.`OrganisationsID` = o.`OrganisationsID`
    ...
    const QUERY_SUBJECTS = '
      ...
      FROM ' . \BO\Zmsbackend\Organisation\Repository\Organisation::TABLE . ' AS o
          INNER JOIN
            (
              SELECT
