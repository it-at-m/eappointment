...
class ExchangeRequestorganisation extends \BO\Zmsbackend\Base
{
    ...
    public function readEntity(
        ...
        foreach ($subjectIdList as $subjectid) {
            $raw = $this
                ->getReader()
                ->fetchAll(
                    constant("\BO\Zmsbackend\Exchange\Repository\ExchangeRequestorganisation::QUERY_READ_REPORT"),
                    [
    ...
    public function readPeriodList($subjectid, $period = 'day')
    {
        ...
        $montsList = $this->getReader()->fetchAll(
            constant("\BO\Zmsbackend\Exchange\Repository\ExchangeRequestorganisation::QUERY_PERIODLIST_MONTH"),
            [
                'organisationid' => $subjectid,
            ]
        );
