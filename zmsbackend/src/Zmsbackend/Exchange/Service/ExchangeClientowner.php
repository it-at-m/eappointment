...
class ExchangeClientowner extends \BO\Zmsbackend\Base
{
    ...
    public function readEntity(
        ...
        foreach ($subjectIdList as $subjectid) {
            $raw = $this
                ->getReader()
                ->fetchAll(
                    constant("\BO\Zmsbackend\Exchange\Repository\ExchangeClientowner::QUERY_READ_REPORT"),
                    [
                        'ownerid' => $subjectid,
    ...
    public function readPeriodList($subjectid, $period = 'day')
    {
        ...
        $montsList = $this->getReader()->fetchAll(
            constant("\BO\Zmsbackend\Exchange\Repository\ExchangeClientowner::QUERY_PERIODLIST_MONTH"),
            [
                'ownerid' => $subjectid,
            ]
        );
