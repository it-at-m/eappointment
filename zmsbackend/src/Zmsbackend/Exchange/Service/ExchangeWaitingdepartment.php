...
class ExchangeWaitingdepartment extends \BO\Zmsbackend\Base implements \BO\Zmsbackend\Interfaces\ExchangeSubject
{
    ...
    public function readEntity(
        ...
        foreach ($subjectIdList as $subjectid) {
            $raw = $this
                ->getReader()
                ->fetchAll(
                    constant("\BO\Zmsbackend\Exchange\Repository\ExchangeWaitingdepartment::QUERY_READ_" . strtoupper($period)),
                    [
    ...
    {
        $raw = $this->getReader()->fetchAll(\BO\Zmsbackend\Exchange\Repository\ExchangeWaitingdepartment::QUERY_SUBJECTS, []);
        $entity = new Exchange();
    ...
    public function readPeriodList($subjectid, $period = 'day')
    {
        ...
        $montsList = $this->getReader()->fetchAll(
            constant("\BO\Zmsbackend\Exchange\Repository\ExchangeWaitingdepartment::QUERY_PERIODLIST_MONTH"),
            [
                'departmentid' => $subjectid,
            ]
        );
