...
class ExchangeRequestscope extends \BO\Zmsbackend\Base
{
    ...
    public function readEntity(
        ...
        $raw = $this
            ->getReader()
            ->fetchAll(
                constant("\BO\Zmsbackend\Exchange\Repository\ExchangeRequestscope::QUERY_READ_REPORT"),
                [
    ...
    public function readPeriodList($subjectid, $period = 'day')
    {
        ...
        $montsList = $this->getReader()->fetchAll(
            constant("\BO\Zmsbackend\Exchange\Repository\ExchangeRequestscope::QUERY_PERIODLIST_MONTH"),
            [
                'scopeid' => $subjectid,
            ]
        );
