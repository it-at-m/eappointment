...
class Db
{
    ...
    public static function startUsingDatabase($dbname = null, $verbose = true): \BO\Zmsbackend\Connection\Pdo
    {
        if (!self::$baseDSN) {
        ...
        if ($dbname === null) {
            \BO\Zmsbackend\Connection\Select::$writeSourceName = self::$baseDSN;
        } else {
            $dbname_zms =& \BO\Zmsbackend\Connection\Select::$dbname_zms;
            \BO\Zmsbackend\Connection\Select::$writeSourceName =
