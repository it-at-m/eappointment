    ...
    */
    public function deleteEntity($itemId)
    {
        ...
        if (0 < $entity->toProperty()->organisations->get()->count()) {
            throw new \BO\Zmsbackend\Owner\Exception\OrganisationListNotEmpty();
        }
        $query =  new \BO\Zmsbackend\Owner\Repository\Owner(\BO\Zmsbackend\Query\Base::DELETE);
    ...
    {
        $query = new \BO\Zmsbackend\Owner\Repository\Owner(\BO\Zmsbackend\Query\Base::INSERT);
    ...
    {
        $query = new \BO\Zmsbackend\Owner\Repository\Owner(\BO\Zmsbackend\Query\Base::UPDATE);
