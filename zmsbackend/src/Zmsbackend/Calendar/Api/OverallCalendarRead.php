...
use BO\Zmsbackend\OverviewCalendar\Service\OverviewCalendar as BookingQuery;
...
class OverallCalendarRead extends \BO\Zmsbackend\Api\BaseController
{
    ...
    public function readResponse(
        ...
        (new \BO\Zmsbackend\Helper\User($request))->checkPermissions('overviewcalendar');
        ...
        if (empty($scopeIds)) {
            return Render::withJson($response, \BO\Zmsbackend\Api\Response\Message::create($request)->setUpdatedMetaData(), 200);
        }
