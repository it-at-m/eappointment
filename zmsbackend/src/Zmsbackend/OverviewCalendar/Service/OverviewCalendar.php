...
namespace BO\Zmsbackend\OverviewCalendar\Service;

use BO\Zmsbackend\Calendar\Repository\OverviewCalendar as Calender;
use DateInterval;
use DateTimeImmutable;
use DateTimeInterface;

class OverviewCalendar extends \BO\Zmsbackend\Base
{
    ...
    public function updateByProcess(
        ...
        return (bool)$this->perform(\BO\Zmsbackend\Calendar\Repository\OverviewCalendar::UPDATE_BY_PROCESS, [
            'process_id' => $processId,
            'scope_id' => $scopeId,
            'starts_at' => $this->formatDateTime($startsAt),
            'ends_at' => $this->formatDateTime($endsAt),
