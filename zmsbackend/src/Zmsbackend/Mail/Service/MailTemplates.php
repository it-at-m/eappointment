...
class MailTemplates extends \BO\Zmsbackend\Base
{
    /**
     *
    ...
    {
        $query = \BO\Zmsbackend\Mail\Repository\Mailtemplate::QUERY_SELECT;
    ...
    {
        $query = new \BO\Zmsbackend\Mail\Repository\Mailtemplate(\BO\Zmsbackend\Query\Base::INSERT);
    ...
    public function updateEntity(MailTemplate $config)
    {
        ...
        $result = false;
        $query = new \BO\Zmsbackend\Mail\Repository\Mailtemplate(\BO\Zmsbackend\Query\Base::REPLACE);
