...
use \BO\Zmsbackend\Availability\Service\Availability as AvailabilityQuery;
use \BO\Zmsbackend\Scope\Service\Scope as ScopeQuery;
use \BO\Zmsbackend\Process\Service\Process as ProcessQuery;
 ...
 *
 */
class ProcessTest extends \BO\Zmsbackend\Tests\Service\Base
{
    ...
    public function testReadByWorkstation()
    {
        ...
        $workstation->process = (new \BO\Zmsbackend\Workstation\Service\Workstation)->writeAssignedProcess($workstation, $process, $now);
    ...
    public function testProcessStatusCalled()
    {
        ...
        $process = $query->updateProcessStatus($process, 'called', $now);
    ...
    public function testProcessStatusFinished()
    {
        ...
        $queryArchived = new \BO\Zmsbackend\Process\Service\ProcessStatusArchived();
        $archived = $queryArchived->writeEntityFinished($entity, $now);
        //$this->dumpProfiler();
        $process =(new Query)->readEntity(10029, new \BO\Zmsbackend\Helper\NoAuth(), 0);
    ...
    public function testStatusFree()
    {
        ...
        $processList = \BO\Zmsbackend\Process\Service\ProcessStatusFree::init()->readFreeProcesses($calendar, $now);
    ...
    public function testDeallocateProcess()
    {
        ...
        $job = new \BO\Zmsbackend\Helper\AppointmentDeallocateByCron($dateTime->modify('+10 minutes'), false);
