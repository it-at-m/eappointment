...
class ProcessListSummaryMailTest extends \BO\Zmsbackend\Tests\Api\Base
{
    ...
    public function testRendering()
    {
        ...
        (new \BO\Zmsbackend\Process\Service\Process)->updateEntity($entity, \App::getNow());

        $updated = (new \BO\Zmsbackend\Process\Service\Process)->readEntity(10118, $entity->authKey, 0);
    ...
    {
        $this->expectException('BO\Zmsbackend\Process\Exception\ProcessListSummaryTooOften');
    ...
    {
        $configRepository = (new \BO\Zmsbackend\Config\Service\Config());
