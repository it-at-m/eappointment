...
class SessionUpdateTest extends \BO\Zmsbackend\Tests\Api\Base
{
    ...
    {
        $this->expectException('\BO\Zmsbackend\Matching\Exception\ProviderNotFound');
        $this->render([], [
            '__body' => '{
                "id": "unittest",
                "name": "unittest",
    ...
    {
        $this->expectException('\BO\Zmsbackend\Matching\Exception\MatchingNotFound');
        $this->render([], [
            '__body' => '{
                "id": "unittest",
                "name": "unittest",
