...
class WarehousePeriodGetTest extends \BO\Zmsbackend\Tests\Api\Base
{
    ...
    {
        $this->expectException('\BO\Zmsbackend\Warehouse\Exception\UnknownReportType');
        $workstation = $this->setWorkstation();
        $workstation->getUseraccount()->setPermissions('statistic');
        $response = $this->render(
    ...
    {
        $this->expectException('\BO\Zmsbackend\Warehouse\Exception\ReportNotFound');
        $workstation = $this->setWorkstation();
        $workstation->getUseraccount()->setPermissions('statistic');
        $response = $this->render(
