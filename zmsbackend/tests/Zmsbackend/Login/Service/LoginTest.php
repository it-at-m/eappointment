...
namespace BO\Zmsbackend\Tests\Login\Service;
...
class LoginTest extends \BO\Zmsbackend\Tests\Service\Base
{
    public function testBasic()
    {
        ...
        $workstation = $query->writeEntityLoginByName($userAccount->id, md5(static::$password), $now, (new \DateTime())->setTimestamp(time() + 28800));
        ...
        $userAccount->addDepartment((new \BO\Zmsbackend\Department\Service\Department())->readEntity('72')); //Bürgeramt Egon-Erwin-Kisch-Str.
