...
namespace BO\Zmsbackend\Tests\Organisation\Service;

use \BO\Zmsbackend\Organisation\Service\Organisation as Query;
use \BO\Zmsentities\Organisation as Entity;

class OrganisationTest extends \BO\Zmsbackend\Tests\Service\Base
{
    ...
    {
        $query = new Query();
        $this->expectException('\BO\Zmsbackend\Cluster\Exception\ClusterWithoutScopes');
