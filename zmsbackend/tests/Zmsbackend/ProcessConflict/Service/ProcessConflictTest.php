...
namespace BO\Zmsbackend\Tests\ProcessConflict\Service;
 ...
 *
 */
class ProcessConflictTest extends \BO\Zmsbackend\Tests\Service\Base
{
    public function testBasic()
    {
        ...
        $scope = (new \BO\Zmsbackend\Scope\Service\Scope())->readEntity(141, 1, true);
        $conflictList = (new \BO\Zmsbackend\Process\Service\Process())
    ...
    public function testOverbookedOnDay()
    {
        ...
        $scope = (new \BO\Zmsbackend\Scope\Service\Scope())->readEntity(141, 1, true);
        $conflictList = (new \BO\Zmsbackend\Process\Service\Process())->readConflictListByScopeAndTime($scope, $startDate, null, $now, 0);
    ...
    */
    ...
    public function testSingleDayOutOfAvailability()
    {
        ...
        $scope = (new \BO\Zmsbackend\Scope\Service\Scope())->readEntity(154, 1, true);
        $conflictList = (new \BO\Zmsbackend\Process\Service\Process())
    ...
    public function testEqual()
    {
        ...
        $scope = (new \BO\Zmsbackend\Scope\Service\Scope())->readEntity(141, 1, true);
        $availabilityList = (new \BO\Zmsbackend\Availability\Service\Availability())->readAvailabilityListByScope($scope, 1);
        ...
        (new \BO\Zmsbackend\Availability\Service\Availability())->writeEntity($availabilityCopy);
        $conflictList = (new \BO\Zmsbackend\Process\Service\Process())->readConflictListByScopeAndTime($scope, $startDate, null, $now, 0);
        $this->assertEquals(2, $conflictList->count());
