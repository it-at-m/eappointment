...
use \BO\Zmsbackend\Helper\ReservedDataDeleteByCron;
use \BO\Zmsbackend\Process\Service\ProcessStatusFree;
use \BO\Zmsentities\Process as Entity;

class ReservedDataDeleteByCronTest extends \BO\Zmsbackend\Tests\Service\Base
{
    ...
    public function testWithExpiredReservations()
    {
        ...
        $deleteReservationDryRun->setLimit(100);
        $deleteReservationDryRun->startProcessing();
        $this->assertEquals(3, (new \BO\Zmsbackend\Process\Service\Process)->readExpiredReservationsList($now, 380, 10, 0)->count());
        ...
        $this->assertEquals(0, (new \BO\Zmsbackend\Process\Service\Process)->readExpiredReservationsList($now, 380, 10, 0)->count());
    }
