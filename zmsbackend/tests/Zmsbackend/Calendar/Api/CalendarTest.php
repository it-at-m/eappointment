...
class CalendarTest extends \BO\Zmsbackend\Tests\Api\Base
{
    ...
    {
        $this->expectException('BO\Zmsbackend\Calendar\Exception\InvalidFirstDay');
        $this->render([], [
            '__body' => '{
                "requests": [
                    {
    ...
    {
        $this->expectException('BO\Zmsbackend\Calendar\Exception\AppointmentsMissed');
        $this->render([], [
            '__body' => '{
                "requests": [
                    {
