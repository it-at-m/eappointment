...
namespace BO\Zmsbackend\Tests\Calendar\Service;

use \BO\Zmsbackend\Calendar\Service\Calendar as Query;
use \BO\Zmsentities\Calendar as Entity;

class CalendarTest extends \BO\Zmsbackend\Tests\Service\Base
{
    ...
    {
        $this->expectException('\BO\Zmsbackend\Calendar\Exception\CalendarWithoutScopes');
