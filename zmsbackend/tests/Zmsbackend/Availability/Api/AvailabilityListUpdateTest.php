...
class AvailabilityListUpdateTest extends \BO\Zmsbackend\Tests\Api\Base
{
    ...
    {
        $this->setWorkstation() ->getUseraccount() ->setPermissions('availability');
        $this->expectException('\BO\Zmsbackend\Availability\Exception\AvailabilityListUpdateFailed');
        $this->expectExceptionCode(400);
        $this->render([], [
            '__body' => '{
                "availabilityList": [
    ...
    public function testWeekdayValidation()
    {
        ...
        $this->assertEquals('BO\\Zmsbackend\\Availability\\Exception\\AvailabilityListUpdateFailed', $responseData['meta']['exception']);
