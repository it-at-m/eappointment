...
namespace BO\Zmsbackend\Tests\CompareFreeProcesses\Service;

use \BO\Zmsbackend\Calendar\Service\Calendar;
use \BO\Zmsbackend\Process\Service\ProcessStatusFree;
use \BO\Zmsbackend\Scope\Service\Scope;

class CompareFreeProcessesTest extends \BO\Zmsbackend\Tests\Service\Base
{
    ...
    public function testBasic()
    {
        ...
        $freeProcessesTime = 0;
        $scopeList = (new \BO\Zmsbackend\Scope\Service\Scope())->readList();
        //$scopeList = new \BO\Zmsentities\Collection\ScopeList();
        //$scopeList->addEntity((new \BO\Zmsbackend\Scope\Service\Scope())->readEntity(145));
        foreach ($scopeList as $scope) {
            ...
            $calendar = (new \BO\Zmsbackend\Calendar\Service\Calendar())->readResolvedEntity($input, $now);
            ...
            $input2->firstDay = $day;
            $freeProcessList = \BO\Zmsbackend\Process\Service\ProcessStatusFree::init()->readFreeProcesses($input2, $now);
