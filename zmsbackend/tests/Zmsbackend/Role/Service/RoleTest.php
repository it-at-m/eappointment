...
namespace BO\Zmsbackend\Tests\Role\Service;

use BO\Zmsbackend\Role\Service\Role as Query;
use BO\Zmsentities\Role as Entity;

class RoleTest extends \BO\Zmsbackend\Tests\Service\Base
{
     ...
     *
     * This bypasses \BO\Zmsbackend\Useraccount\Service\Useraccount::writeUpdatedEntity() intentionally because these tests use
     ...
     */
    private function replaceUserRoleDirectly(\BO\Zmsbackend\Useraccount\Service\Useraccount $userQuery, string $loginName, int $roleId): void
    {
        $userQuery->perform(
    ...
    {
        $roleQuery = new Query();
        $userQuery = new \BO\Zmsbackend\Useraccount\Service\Useraccount();
