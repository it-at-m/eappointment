...
namespace BO\Zmsbackend\Tests\SlotList\Service;

use \BO\Zmsbackend\Slot\Repository\SlotList;
use \BO\Zmsentities\Collection\SlotList as Collection;

class SlotListTest extends \BO\Zmsbackend\Tests\Service\Base
{
    ...
    {
        $this->expectException('\BO\Zmsbackend\Slot\Exception\SlotDataEmpty');
    ...
    {
        $this->expectException('\BO\Zmsbackend\Slot\Exception\SlotDataWithoutPreGeneratedSlot');
