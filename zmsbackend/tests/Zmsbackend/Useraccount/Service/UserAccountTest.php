 ...
 *
 */
class UserAccountTest extends \BO\Zmsbackend\Tests\Service\Base
{
    ...
    public function testReadLoggedInHashByName()
    {
        ...
        $hash = (new \BO\Zmsbackend\Workstation\Service\Workstation())->readLoggedInHashByName($workstation->useraccount->id);
    ...
    public function testReadByUserId()
    {
        ...
        $useraccount->departments[] = (new \BO\Zmsbackend\Department\Service\Department())->readEntity(72);
        $this->assertEntity("\\BO\\Zmsentities\\Useraccount", $useraccount);
    ...
    public function testReadList()
    {
        ...
        foreach ($entityList as $entity) {
            $entity->departments[] = (new \BO\Zmsbackend\Department\Service\Department())->readEntity(72);
            $entity->id = "superuser";
        }
    ...
    {
        $this->writeTestLogin();
        $workstation = (new \BO\Zmsbackend\Workstation\Service\Workstation())->readWorkstationByScopeAndName(141, 4);
    ...
    public function testWriteRemovedProcess()
    {
        $now = static::$now;
        $workstation = $this->writeTestLogin();
        $process = (new \BO\Zmsbackend\Process\Service\Process)->readEntity(10029, '1c56');
    ...
    public function testLoginFailed()
    {
        ...
        (new \BO\Zmsbackend\Workstation\Service\Workstation())->writeEntityLoginByName('johndoe', 'secret',$now, (new \DateTime())->setTimestamp($now->getTimestamp() + 28800));
    }
    ...
    public function testWriteHintByName()
    {
        ...
        $workstation = (new \BO\Zmsbackend\Workstation\Service\Workstation())->updateEntity($workstationInput);
    ...
    protected function writeTestLogin()
    {
        ...
        $workstation = (new \BO\Zmsbackend\Workstation\Service\Workstation())->writeEntityLoginByName($userAccount->id, $input->password, $this->dateTime, (new \DateTime())->setTimestamp(time() + 28800));
        ...
        return (new \BO\Zmsbackend\Workstation\Service\Workstation())->updateEntity($workstationInput, 1);
    }
