<?php
namespace BO\Zmsbackend\Tests\OverviewCalendar\Service;

use BO\Zmsbackend\OverviewCalendar\Service\OverviewCalendar;
...
class OverviewCalendarTest extends \BO\Zmsbackend\Tests\Service\Base
{
    ...
    {
        $calendar = new \BO\Zmsbackend\OverviewCalendar\Service\OverviewCalendar();
    ...
    {
        $cal = new \BO\Zmsbackend\OverviewCalendar\Service\OverviewCalendar();
