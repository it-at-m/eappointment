...
class WorkstationProcessParkedTest extends \BO\Zmsbackend\Tests\Api\Base
{
    ...
    public function testRendering()
    {
        ...
        $entity = (new \BO\Zmsbackend\Process\Service\Process)->readEntity(self::PROCESS_ID, new \BO\Zmsbackend\Helper\NoAuth);
