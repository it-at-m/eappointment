...
class CounterGhostWorkstationTest extends \BO\Zmsbackend\Tests\Api\Base
{
    ...
    public function testNoAccess()
    {
        $this->setWorkstation()
            ->getUseraccount()
            ->setPermissions('counter');
        $this->expectException('\BO\Zmsbackend\Scope\Exception\ScopeNoAccess');
    ...
    public function testNotFound()
    {
        $this->setWorkstation()
            ->getUseraccount()
            ->setPermissions('counter');        $this->expectException('\BO\Zmsbackend\Scope\Exception\ScopeNotFound');
