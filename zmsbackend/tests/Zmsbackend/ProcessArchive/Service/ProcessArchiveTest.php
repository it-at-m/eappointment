...
namespace BO\Zmsbackend\Tests\ProcessArchive\Service;
 ...
 *
 */
class ProcessArchiveTest extends \BO\Zmsbackend\Tests\Service\Base
{
    ...
    public function testWriteBlockedWithoutQueueStatus()
    {
        ...
        $this->assertTrue((new \BO\Zmsbackend\Process\Service\ProcessStatusArchived())->writeBlockedEntity($entity));
    }
    ...
    public function testWriteNewArchivedWithoutAppointment()
    {
        ...
        $archivedProcessWaitingData = (new \BO\Zmsbackend\Exchange\Service\ExchangeWaitingscope)->readByDateTime($updatedEntity->scope, $entity->getArrivalTime($now));
