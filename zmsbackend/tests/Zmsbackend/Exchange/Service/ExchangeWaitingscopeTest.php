...
use \BO\Zmsbackend\Exchange\Service\ExchangeWaitingscope as Query;
use \BO\Zmsentities\Exchange;
use \DateTimeImmutable as DateTime;

class ExchangeWaitingscopeTest extends \BO\Zmsbackend\Tests\Service\Base
{
    ...
    public function testWriteWaitingTime()
    {
        ...
        $process = (new \BO\Zmsbackend\Process\Service\ProcessStatusQueued())->writeNewFromTicketprinter($scope, $now);
        ...
        (new \BO\Zmsbackend\Process\Service\ProcessStatusQueued())->writeNewFromTicketprinter($scope, $now);
        $query->writeWaitingTimeCalculated($scope, $now);
        $entry = $query->readByDateTime($scope, $now);
