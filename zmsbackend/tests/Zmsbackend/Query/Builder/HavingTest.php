...
use BO\Zmsbackend\Query\Builder\ConditionBuilder;
...
{
    /**
     * @return \BO\Zmsbackend\Query\Builder\Having
     */
    protected function havingObject()
    {
        return $this->getMockForTrait('BO\\Zmsbackend\\Query\\Builder\\Having');
    }
