...
namespace BO\Zmsbackend\Tests\Ics\Service;

use \BO\Zmsbackend\Config\Service\Config as Config;
use \BO\Zmsbackend\Process\Service\Process;
use \BO\Zmsentities\Ics as Entity;

class IcsTest extends \BO\Zmsbackend\Tests\Service\Base
{
    public function testBasic()
    {
        setlocale(LC_ALL, 'de_DE');
        $testTimestamp = 1463062089; // 12.5.2016, 16:08:09 GMT+2:00 DST saved in base64 ics string below
        $process = (new \BO\Zmsbackend\Process\Service\Process())->readEntity(169530, 'b3b0', 3); //process from testDB import
        ...
        $this->assertStringContainsString('eyJpZCI6MTY5NTMwLCJhdXRoS2V5IjoiYjNiMCJ9', $ics->getContent());
    ...
    {
        $testTimestamp = 1463062089; // 12.5.2016, 16:08:09 GMT+2:00 DST saved in base64 ics string below
        $process = (new \BO\Zmsbackend\Process\Service\Process())->readEntity(169530, 'b3b0'); //process from testDB import
