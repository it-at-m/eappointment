...
This repository does not use git submodules for these components; module documentation lives directly in-repo.
...
- Primary module details remain maintained in each module README.
- Top-level docs provide cross-module guidance and linking.
- Wiki publication syncs only selected markdown from `docs/`.
