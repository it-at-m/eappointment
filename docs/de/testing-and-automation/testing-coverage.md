...
Die Coverage-HTML-Berichte aus der CI werden unter [https://it-at-m.github.io/eappointment/](https://it-at-m.github.io/eappointment/) veröffentlicht.
...
- [zmscitizenbackend](https://it-at-m.github.io/eappointment/coverage/coverage-zmscitizenbackend/html/)
...
API-Dokumentation und Diagramme siehe [API-Referenz](../operations/api-reference.md).
