...
Dieses Repository nutzt für diese Komponenten keine Git-Submodule; die Modul-Dokumentation liegt direkt im Repository.

## Modul-READMEs

Die Links öffnen die README auf GitHub (Branch `main`).
...
- [zmsbackend/README.md](https://github.com/it-at-m/eappointment/blob/main/zmsbackend/README.md)
- [zmsbackend/public/doc/README.md](https://github.com/it-at-m/eappointment/blob/main/zmsbackend/public/doc/README.md)
...
- Die Detailinformationen zu jedem Modul werden weiterhin in der jeweiligen Modul-README gepflegt.
- Die übergreifende Dokumentation auf oberster Ebene liefert modulübergreifende Hinweise und Verlinkungen.
- Die Wiki-Veröffentlichung synchronisiert nur ausgewählte Markdown-Dateien aus `docs/`.
