...
- `zmslayout` – eingebettete Layout-Assets (gemeinsames SCSS/JS). Wird per npm-`file:`-Abhängigkeit von `zmsadmin` und `zmsstatistic` bezogen (siehe [`zmslayout/README.md`](https://github.com/it-at-m/eappointment/blob/main/zmslayout/README.md)).
