export default {
  ...
  base: "/eappointment/guide/",
  themeConfig: {
    nav: [
      { text: "Overview", link: "/" },
      { text: "GitHub Wiki", link: "https://github.com/it-at-m/eappointment/wiki" },
      { text: "Pages Reports", link: "https://it-at-m.github.io/eappointment/" }
    ],
    sidebar: [
      ...
      { text: "Operations", items: [{ text: "Testing", link: "/testing" }, { text: "Operations", link: "/operations" }] },
