export default {
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      { text: "Setup and Development", items: [{ text: "Dependency Graph", link: "/dependency-graph" }, { text: "Branching Strategy", link: "/branching-strategy-and-convention" }, { text: "Commit Message Convention", link: "/commit-message-convention" }, { text: "Getting Started", link: "/getting-started" }, { text: "Development", link: "/development" }, { text: "PHP Base Images", link: "/php-base-images" }] },
      { text: "Operations", items: [{ text: "Testing", link: "/testing" }, { text: "API reference", link: "/api-reference" }, { text: "Operations", link: "/operations" }, { text: "DLDB Interface Documentation", link: "/dldb-interface-documentation" }] },
