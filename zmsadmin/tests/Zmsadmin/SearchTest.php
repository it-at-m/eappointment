...
class SearchTest extends Base
{
    ...
    public function testZeroCustomTextfieldTriggersProcessSearch()
{
    $this->setApiCalls(
        [
            [
    ...
    $response = $this->render($this->arguments, ['customTextfield' => '0'], []);

    $this->assertStringContainsString('name="customTextfield" value="0"', (string)$response->getBody());
    $this->assertEquals(200, $response->getStatusCode());
}

    public function testZeroCustomTextfield2TriggersProcessSearch()
{
    $this->setApiCalls(
        [
            [
    ...
    $response = $this->render($this->arguments, ['customTextfield2' => '0'], []);

    $this->assertStringContainsString('name="customTextfield2" value="0"', (string)$response->getBody());
    $this->assertEquals(200, $response->getStatusCode());
}

    public function testCustomerSearchByCustomTextfieldWithoutTextQuery()
    {
        $this->setApiCalls(
            [
                [
        ...
        $response = $this->render($this->arguments, ['customTextfield' => 'Test'], []);
        $this->assertStringContainsString('name="customTextfield" value="Test"', (string) $response->getBody());
        $this->assertEquals(200, $response->getStatusCode());
    }

    public function testCustomerSearchByCustomTextfield2WithoutTextQuery()
{
    $this->setApiCalls(
        [
            [
    ...
    $response = $this->render($this->arguments, ['customTextfield2' => 'Test'], []);

    $this->assertStringContainsString('name="customTextfield2" value="Test"', (string) $response->getBody());
    $this->assertEquals(200, $response->getStatusCode());
    }
}
