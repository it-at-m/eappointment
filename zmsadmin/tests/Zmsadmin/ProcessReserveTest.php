...
class ProcessReserveTest extends Base
{
    ...
    public function testWithRequiredMail()
    {
        ...
        $this->assertStringContainsString('den Standort muss eine', $responseData['email']['messages'][0]['message']);
        $this->assertStringContainsString('E-Mail Adresse eingetragen werden', $responseData['email']['messages'][0]['message']);
        $this->assertEquals(200, $response->getStatusCode());
    }
