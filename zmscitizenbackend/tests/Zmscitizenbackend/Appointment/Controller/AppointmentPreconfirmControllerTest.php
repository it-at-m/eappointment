...
use BO\Zmscitizenbackend\Appointment\Exception\ProcessNotReservedAnymore;
...
{
    protected $classname = "\BO\Zmscitizenbackend\Appointment\Controller\AppointmentPreconfirmController";
