...
https://it-at-m.github.io/eappointment/zmscitizenbackend/public/doc/index.html
```


* Under /public/doc/schema are the citizen JSON schemas owned by this module (`../../schema`).
