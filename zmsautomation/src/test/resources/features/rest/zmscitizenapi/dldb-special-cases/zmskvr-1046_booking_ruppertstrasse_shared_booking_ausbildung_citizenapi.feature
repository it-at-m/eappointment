...
Feature: Citizen API: Ruppertstraße shared booking (Haupt 10489 + Ausbildung 10313237)
  ...
  Scenario: Ruppertstraße shared-booking peers expose sharedBookingOfficeIds
    Then office 10489 should have sharedBookingOfficeIds "10489,10313237,10500,10491"
    And office 10313237 should have sharedBookingOfficeIds "10489,10313237,10500,10491"
    And office 10500 should have sharedBookingOfficeIds "10489,10313237,10500,10491"
    And office 10491 should have sharedBookingOfficeIds "10489,10313237,10500,10491"

  @sharedBooking
  Scenario: Available calendar for both peers returns buckets for 10489 and 10313237 without duplicate timestamps
  ...
  Scenario: Wohnsitzanmeldung reserved from Ausbildung bucket 10313237
    When I request available days for offices "10489,10313237" and service 1063475
    Then the available calendar should include appointments for offices "10489,10313237"
  ...
  # Beglaubigung 1063426 is offered at Haupt 10489 only (not Ausbildung 10313237).
  @sharedBooking @mainCalendar
  Scenario: Beglaubigung calendar for 10489 has slots only for 10489, not 10313237
    ...
    And the available calendar should not include appointments for offices "10313237"

  @sharedBooking
  Scenario: Beglaubigung with both shared peers is rejected
    When I request available days for offices "10489,10313237" and service 1063426
    Then the response status code should be 400

  # Haushaltsbescheinigung 1080843 is at 10489+10313237; Personendaten 10224136 only at 10489.
  # available-calendar must not be called with peer 10313237 for this combination.
  @sharedBooking @mainCalendar
  ...
  Scenario: Combined Haushaltsbescheinigung + Personendaten with both shared peers is rejected
    When I request available days for offices "10489,10313237" and services "1080843,10224136"
    Then the response status code should be 400