#language: en
@web @zmscitizenview @dldb-special-cases @citizen @ZMSKVR-1124 @executeLocally
Feature: CitizenView: Ruppertstraße Passkalender, Hauptkalender und Abholung (jump-in)
  As a citizen
