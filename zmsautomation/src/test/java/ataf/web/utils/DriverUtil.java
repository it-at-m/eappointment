...
// Fork of ATAF 0.3.3 DriverUtil: Chrome lacks browserHeadless support upstream; CI needs
// --headless=new for Chromium 150+ in Docker (non-headless exits immediately under Xvfb).
// Sync with de.muenchen.ataf:web when upgrading ATAF.
...
public final class DriverUtil {
    ...
    public static RemoteWebDriver initDriver(boolean isLocalExecution) throws MalformedURLException {
        ...
        final boolean browserHeadless = TestProperties.getProperty("browserHeadless", true, false).orElse(false);
