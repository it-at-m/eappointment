...
import test.automation.framework.pages.statistics.StatisticsPage;
import test.automation.framework.pages.statistics.StatisticsPageContext;
import test.automation.framework.pages.statistics.evaluations.CustomerStatisticsPage;
import test.automation.framework.pages.statistics.evaluations.ServiceStatisticsPage;
import test.automation.framework.pages.statistics.evaluations.WaitStatisticsPage;
import test.automation.framework.pages.statistics.rawdata.CategoriesPage;
