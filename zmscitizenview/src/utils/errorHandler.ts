...
export function createErrorStateMap(): ErrorStateMap {
  ...
  const errorStateNames = [
    ...
    "apiErrorCustomTextfieldCannotBeChanged",
    "apiErrorCustomTextfield2CannotBeChanged",
    "apiErrorDepartmentNotFound",
    "apiErrorEmailCannotBeChanged",
    ...
    "apiErrorFamilyNameCannotBeChanged",
    ...
    "apiErrorTelephoneCannotBeChanged",
