...
class ErrorMessages
{
    ...
    private const MESSAGES = [
        ...
        'invalidCustomTextfield' => [
            ...
            'statusCode' => self::HTTP_BAD_REQUEST,
            'errorType' => 'warning',
            'errorMessage' => 'customTextfield must be non-empty when required and at most 255 characters after normalization.'
        ],
        'invalidCustomTextfield2' => [
            'errorCode' => 'invalidCustomTextfield2',
            'statusCode' => self::HTTP_BAD_REQUEST,
            'errorType' => 'warning',
            'errorMessage' => 'customTextfield2 must be non-empty when required and at most 255 characters after normalization.'
        ],
