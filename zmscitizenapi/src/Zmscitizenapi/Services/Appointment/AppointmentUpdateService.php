...
class AppointmentUpdateService
{
    ...
    private function extractClientData(array $body): object
    {
        return (object) [
            ...
            'customTextfield1' => isset($body['customTextfield1']) && is_string($body['customTextfield1']) ? (string) $body['customTextfield1'] : null,
    ...
    private function updateProcessWithClientData(ThinnedProcess $process, object $data): ThinnedProcess
    {
        ...
        $process->customTextfield1 = $data->customTextfield1 ?? $process->customTextfield1 ?? null;
