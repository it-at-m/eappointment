...
| ZMS_CITIZENAPI_PLACEHOLDER_EMAIL | Undeliverable placeholder set on reserve before the citizen submits real contact data | noreply-terminvereinbarung@muenchen.de |
| **Cache & Maintenance** |
